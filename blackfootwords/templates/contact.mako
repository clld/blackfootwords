...
<div class="well">
    <p>${_('You can contact us with any questions via email at natalie.weber@yale.edu.')} <a href="mailto:${request.contact_email_address}">${request.contact_email_address}</a>.</p>
